...
USER_NAME = os.environ.get('USER_NAME', 'younnieCutler')
...
if __name__ == '__main__':
    ...
    birth_year = int(os.environ.get('BIRTH_YEAR', 1999))
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and os.path.exists('cache/repository_archive.txt'): # only calculate for user Andrew6rant
